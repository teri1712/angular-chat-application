...
const DESIGN_TOKENS_JSON = 'src/assets/design-tokens.json';
const DESIGN_TOKENS_CSS = 'src/assets/design-tokens.css';
const GENERATE_TOKENS_SCRIPT = '.gemini/skills/design-system/scripts/generate-tokens.cjs';
